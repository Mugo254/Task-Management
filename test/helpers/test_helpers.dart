...
@GenerateMocks(
  ...
  customMocks: [
    ...
    MockSpec<ReminderService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
  ],
)
...
MockReminderService getAndRegisterReminderService() {
  _removeRegistrationIfExists<ReminderService>();
  final service = MockReminderService();
  locator.registerSingleton<ReminderService>(service);
  return service;
}
// @stacked-mock-create
